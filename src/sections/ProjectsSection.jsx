        ...
        <div className="bg-white dark:bg-[#16131F] rounded-[3rem] py-16 shadow-2xl border border-[#C1A0AC]/30 dark:border-[#C1A0AC]/20 transition-colors duration-500">
          ...
          <div className="flex flex-col items-center mb-10 text-center px-[5%]">
            <p className="text-[#806C79] text-sm md:text-base tracking-[0.3em] uppercase opacity-80">
              Desarrollo, Innovación e Ingeniería
            </p>
          </div>
                  ...
                  >
                    ...
                    <div className="w-full h-48 md:h-52 overflow-hidden bg-white dark:bg-[#16131F] shrink-0 border-b border-[#C1A0AC]/30 dark:border-[#4A3F4B]/50 transition-colors duration-500">
                      {project.image ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center text-[#806C79]">Sin imagen</div>
                      )}
                    </div>
                    ...
                    <div className="p-6 md:p-8 flex flex-col grow gap-4">
                      ...
                      {/* Stack Técnico */}
                      <div className="mt-2">
                        <p className="text-[#C1A0AC] text-[10px] tracking-[0.2em] uppercase font-bold mb-2">Stack Técnico</p>
                      ...
                      {/* Habilidades Blandas */}
                      <div className="mt-1">
                        <p className="text-[#C1A0AC] text-[10px] tracking-[0.2em] uppercase font-bold mb-2">Habilidades Blandas</p>
                        <div className="flex flex-wrap gap-2">
                      ...
                      <div className="flex gap-4 mt-4 pt-4 border-t border-[#C1A0AC]/30 dark:border-[#4A3F4B]/40 transition-colors duration-500">
                        {project.repo && project.repo !== "#" && (
                          <a href={project.repo} target="_blank" rel="noreferrer" title="Ver Repositorio" className="p-3 bg-white dark:bg-[#16131F] rounded-full text-[#C1A0AC] hover:text-[#4A3F4B] dark:hover:text-[#FAFAFA] hover:bg-[#C1A0AC]/20 transition-all duration-300 shadow-sm dark:shadow-none">
                            <FaGithub className="text-xl" />
                          </a>
                        )}
                        {project.demo && project.demo !== "#" && (
                          <a href={project.demo} target="_blank" rel="noreferrer" title="Ver Demo en Vivo" className="p-3 bg-white dark:bg-[#16131F] rounded-full text-[#C1A0AC] hover:text-[#4A3F4B] dark:hover:text-[#FAFAFA] hover:bg-[#C1A0AC]/20 transition-all duration-300 shadow-sm dark:shadow-none">
