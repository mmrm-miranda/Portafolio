      ...
      <div className="max-w-[1400px] w-full relative">
        ...
        <div className="bg-white dark:bg-[#16131F] rounded-[3rem] p-12 pt-20 md:p-20 md:pt-24 shadow-[0_20px_50px_rgba(0,0,0,0.1)] border border-[#C1A0AC]/30 dark:border-[#C1A0AC]/20 transition-colors duration-500">
          ...
          <div className="flex flex-col items-center text-center gap-16">
            ...
            {/* Grid de Redes Sociales con Shimmer[cite: 9] */}
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-[1200px]">
              {contactLinks.map((link) => (
                <a 
                  ...
                  className="group relative flex flex-col items-center justify-center gap-6 p-10 rounded-[2rem] bg-[#4A3F4B]/5 dark:bg-[#4A3F4B]/20 border border-[#C1A0AC]/10 overflow-hidden transition-all duration-500 hover:border-[#C1A0AC] hover:-translate-y-3 hover:shadow-2xl
                             after:content-[''] after:absolute after:top-0 after:left-0 after:w-full after:h-full after:bg-gradient-to-r after:from-transparent after:via-white/30 after:to-transparent after:-translate-x-full hover:after:animate-shimmer"
                >
                  ...
                  {/* Decoración inferior estilo Skills */}
